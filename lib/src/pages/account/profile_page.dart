    ...
    await FirebaseFirestore.instance
      ...
      querySnapshot.docs.forEach((doc) {
        ...
        sheetObject.appendRow([
          ...
          // excel.TextCellValue(doc["CANTIDAD"] ?? 0),
          ...
          excel.TextCellValue(doc["PRECIO"] ?? 0.00),
          excel.TextCellValue(doc["PRECIO ENTERO"] ?? 0.00),
          excel.TextCellValue(doc["PRECIO PARA MIEMBROS"] ?? 0.00),
